/*Paper of size A0 has dimensions 1189mm x 841mm. Each subsequent size A(n) is defined as A(n-1) cut in half, parallel to its shorter sides. Thus, Paper A1 would have dimensions 841mm x 594mm. Write a program to calculate and print paper sizes A0, A1......A8.*/
#include <stdio.h>
#include <math.h>
int main()
{
